...
namespace DNET
{
    ...
    public sealed class Crc32
    {
        ...
        /// 计算单字节的CRC
        /// </summary>
        /// <param name="oldCrc">当前CRC值</param>
        /// <param name="bval">当前字节</param>
        /// <returns>更新后的CRC</returns>
        ...
        /// 计算Crc
        /// </summary>
        /// <param name="bval">输入字节</param>
        /// <returns>CRC结果</returns>
        public static uint Crc(int bval)
        {
            uint crc = 0;
            crc ^= CrcSeed;
        ...
        /// <returns>CRC结果</returns>
        public static uint Crc(byte[] buf, int off, int len)
        {
            uint crc = 0;
            if (buf == null) {
